...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // No hay "else". Si el error es de red o servidor caído, 
      // api.js ya se encargó de disparar la ventana emergente global.
    }
  };
        ...
        <div className="col-md-4">
          <div className="card shadow border-primary">
            ...
            <div className="card-body">
              {/* Alerta INLINE gestionada por el componente */}
